...
course_df['course_price'] = [
    price // 1000 for price in course_df['course_price']
]
...
metrics = match_evaluation(user_embedding, item_embedding, val_user, all_item, topk=50)
json.dump(metrics, open('dssm_eval.json','w'))
